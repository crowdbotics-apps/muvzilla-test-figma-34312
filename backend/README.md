...
## Project Structure
    ...
    ├── muvzilla_test_figma_34312  # Django project configurations
...
1. Clone this repo and `cd muvzilla_test_figma_34312`
...
2. Clone this repo and `cd muvzilla_test_figma_34312`
